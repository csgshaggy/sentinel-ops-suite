# /home/ubuntu/sentinel-ops-suite/backend/app/routers/plugins.py
# SentinelOps — Plugin Management Router (Corrected Prefix)
...
# ------------------------------------------------------------
# FIXED: Explicit prefix (no /api here)
...
# ------------------------------------------------------------
# Timing Metrics (kept outside /plugins namespace)
# ------------------------------------------------------------
...
# Plugin Logs
# ------------------------------------------------------------
@router.get("/{plugin_id}/logs", response_model=List[str])
