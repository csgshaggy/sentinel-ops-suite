...
export const pluginCategories: PluginCategory[] = [
  {
    ...
    description:
      "Kernel, hardware, processes, memory, CPU, disk, and OS-level diagnostics.",
  },
  {
    id: "python",
    label: "Python Environment",
    description:
      "Interpreter, venv, packages, dependency drift, and runtime validation.",
  },
  {
    id: "project",
    label: "Project / Repo Integrity",
    description:
      "Repo structure, docs, Makefile, CI config, linting, and code health.",
  },
  {
    id: "observability",
    label: "Observability & Diagnostics",
    description:
      "Logging, metrics, tracing, performance, and runtime instrumentation.",
  },
];
